...
public class PatientDAO {
	...
	static {
		patients.add(
				new Patient("001", "Nguyễn Văn Hiếu", "35 đường số 4, Trường Thọ, Thủ Đức", "0798631497", 2001, true));
		patients.add(new Patient("002", "Nguyễn Trường Đình", "Trần Phú, Phủ Hà, Quận 12", "0163149752", 2001, true));
		patients.add(
				new Patient("003", "Trần Đình Danh", "KTX A Nông Lâm, Linh Trung, Thủ Đức", "0786951463", 2001, true));
		patients.add(
				new Patient("004", "Nguyễn Hoàng Đức", "Làng đại học, Linh Trung, Thủ Đức", "0335942367", 2001, true));
		patients.add(
				new Patient("005", "Nguyễn Văn Minh", "Làng đại học, Linh Trung, Thủ Đức", "0339741358", 2001, false));
	}
